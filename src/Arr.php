...
class Arr
{
     ...
     * @return array
     */
    public static function SortByKeyFor2D(array &$array, string $key, bool $desc = false): array
    {
     ...
     * @return array
     */
    public static function extend(array $arrayMaster = [], array $arraySlave = [], string $keyAssoc = '', string $keyNew = ''): array
    {
     ...
     * @return array
     */
    public static function column(array $arr = [], $columnKeys = [], $indexKey = null): array
    {
     ...
     * @return array
     */
    public static function unique(array $input = [], int $sortFlags = SORT_STRING): array
    {
        if (empty($input) || !is_array($input)) return [];
     ...
     * @return array
     */
    public static function force($value = ''): array
    {
        if (is_null($value)) {
            return [];
        }
     ...
     * @return array
     */
    public static function map($arr = [], $callback = null)
    {
        $arr = self::force($arr);
        if (empty($arr)) return [];
